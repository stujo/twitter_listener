...
* USE THIS -- If you are interested in using this, just fork & clone. Then rake db:create and migrate. Add your own .env with Twitter API keys and a secret key base.
